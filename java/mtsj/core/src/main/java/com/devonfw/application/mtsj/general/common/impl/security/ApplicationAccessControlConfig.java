...
public class ApplicationAccessControlConfig extends AccessControlConfig {
  ...
  public ApplicationAccessControlConfig() {
    ...
    AccessControlGroup waiter = group(GROUP_WAITER, PERMISSION_FIND_ORDER, PERMISSION_FIND_BOOKING, PERMISSION_DELETE_ORDER, PERMISSION_SAVE_ORDER,
      PERMISSION_SAVE_BOOKING, PERMISSION_FIND_ORDER_LINE, PERMISSION_DELETE_ORDER_LINE, PERMISSION_SAVE_ORDER_LINE);
    ...
    AccessControlGroup admin = group(GROUP_ADMIN, PERMISSION_FIND_USER, PERMISSION_DELETE_USER, PERMISSION_SAVE_USER,
        PERMISSION_FIND_USER_ROLE, PERMISSION_DELETE_USER_ROLE, PERMISSION_SAVE_USER_ROLE, PERMISSION_FIND_ORDER, PERMISSION_FIND_BOOKING);

    AccessControlGroup customer = group(GROUP_CUSTOMER, PERMISSION_FIND_CATEGORY, PERMISSION_FIND_DISH, 
        PERMISSION_FIND_INGREDIENT, PERMISSION_FIND_BOOKING);
